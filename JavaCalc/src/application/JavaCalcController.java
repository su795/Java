...
public class JavaCalcController implements Initializable{
	...
	public void setNum(int num) {			
		...
		if(isFirst) {
			...
			// String strNum = String.valueOf(num);		기본타입
			// txtDisp.setText(strNum);
			txtDisp.setText(""+num);
			// firstNum = num;
	...
	public void btnPlusHandler() {setOperator(1);}
	public void btnMinusHandler() {setOperator(2);}
	public void btnMultiHandler() {setOperator(3);}
	public void btnDivHandler() {setOperator(4);}
